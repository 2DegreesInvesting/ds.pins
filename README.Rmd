...
The goal of this meetup is to show how we might share data with pins with
Dropbox.
...
We need a way to easily share an evolving dataset and ensure new versions of the
data don't break existing code.
