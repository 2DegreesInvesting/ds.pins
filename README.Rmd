...
Compared to a previous meetup about pins, this one presents pins 1.0.0, which
includes a new more explicit API and greater support for versioning.
...
* Managing pins: Create boards, and read/write/delete/prune versioned pins.
